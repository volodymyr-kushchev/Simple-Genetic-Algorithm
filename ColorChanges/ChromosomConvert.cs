...
{
    public static class ChromosomConvert
    {
        ...
        public static Color FromBoolToColor(bool[] arr)
        {
            ...
            for (int i = 24; i < 32; i++)
                b3[(i - 24)] = arr[i];
            Int32 n0 = Convert.ToInt32(ChromosomConvert.BoolArrayToByte(b0));
            Int32 n1 = Convert.ToInt32(ChromosomConvert.BoolArrayToByte(b1));
            Int32 n2 = Convert.ToInt32(ChromosomConvert.BoolArrayToByte(b2));
            Int32 n3 = Convert.ToInt32(ChromosomConvert.BoolArrayToByte(b3));
